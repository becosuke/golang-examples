...
func (m *MockRepository) Create(arg0 context.Context, arg1 *entity.Stock) (*entity.Stock, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Delete(arg0 context.Context, arg1 *entity.Seal) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 *entity.Seal) (*entity.Stock, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *entity.Stock) (*entity.Stock, error) {
	m.ctrl.T.Helper()
