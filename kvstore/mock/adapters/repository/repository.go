...
func (m *MockRepository) Create(arg0 context.Context, arg1 *entity.Pack) (*entity.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 *entity.Seal) (*entity.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *entity.Pack) (*entity.Pack, error) {
	m.ctrl.T.Helper()
