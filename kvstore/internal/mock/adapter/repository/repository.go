...
// Source: internal/adapter/repository/repository.go
...
import (
	...
	kv "github.com/becosuke/golang-examples/kvstore/internal/entity/kv"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *kv.Pack) (*kv.Pack, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*kv.Pack)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Delete(arg0 context.Context, arg1 *kv.Seal) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 *kv.Seal) (*kv.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *kv.Pack) (*kv.Pack, error) {
	m.ctrl.T.Helper()
