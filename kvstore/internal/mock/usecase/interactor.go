...
// Source: internal/usecase/interactor.go
...
func (m *MockInteractor) Create(arg0 context.Context, arg1 *kv.Pack) (*kv.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Delete(arg0 context.Context, arg1 *kv.Seal) error {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Read(arg0 context.Context, arg1 *kv.Seal) (*kv.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Update(arg0 context.Context, arg1 *kv.Pack) (*kv.Pack, error) {
	m.ctrl.T.Helper()
