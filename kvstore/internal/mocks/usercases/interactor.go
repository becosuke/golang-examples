...
// Source: internal/usecases/interactor.go
...
func (m *MockInteractor) Create(arg0 context.Context, arg1 *node.KeyValueNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Delete(arg0 context.Context, arg1 *node.KeyNode) error {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Read(arg0 context.Context, arg1 *node.KeyNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Update(arg0 context.Context, arg1 *node.KeyValueNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
