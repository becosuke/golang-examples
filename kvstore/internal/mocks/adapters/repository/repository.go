...
// Source: internal/adapters/repository/repository.go
...
import (
	...
	node "github.com/becosuke/golang-examples/grpc/internal/entities/node"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 *node.KeyValueNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0, arg1)
	ret0, _ := ret[0].(*node.KeyValueNode)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRepository) Delete(arg0 context.Context, arg1 *node.KeyNode) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 *node.KeyNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 *node.KeyValueNode) (*node.KeyValueNode, error) {
	m.ctrl.T.Helper()
