...
import (
	...
	entity "github.com/becosuke/golang-examples/rest/domain/entity"
...
func (m *MockRepository) Create(arg0 context.Context, arg1, arg2 string) (*entity.Entity, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Read(arg0 context.Context, arg1 string) (*entity.Entity, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1, arg2 string) (*entity.Entity, error) {
	m.ctrl.T.Helper()
