...
func (m *MockInteractor) Create(arg0 context.Context, arg1 *entities.Node) (*entities.Node, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Delete(arg0 context.Context, arg1 *entities.NodeKey) error {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Read(arg0 context.Context, arg1 *entities.NodeKey) (*entities.Node, error) {
	m.ctrl.T.Helper()
...
func (m *MockInteractor) Update(arg0 context.Context, arg1 *entities.Node) (*entities.Node, error) {
	m.ctrl.T.Helper()
